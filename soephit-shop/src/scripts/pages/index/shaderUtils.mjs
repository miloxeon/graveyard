...
export const tween = (props = {}) => {
	const { time = 0, from = 0, to = 1, duration = 1, delay = 0, edge = 0, ease = 'linear' } = props
...
export const frag = `
	...
	float noise(vec3 v) { 
		...
		// 42 is gain
		// increase to make things heavier
